    ...
    ! function(z) {
        ...
        J.VERSION = "1.13.9", J.DEFAULTS = {
            ...
            render: function() {
                ...
                else if ((e = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && 0 < n) && (e = 0 < (t = this.options.selectedTextFormat.split(">")).length && n > t[1] || 1 === t.length && 0 <= n), !1 === e) {
